...
def setup_ngrok_tunnel():
    ...
    # ngrok.set_auth_token(ngrok_token) # Older way, using conf is better
...
def launch_streamlit():
    ...
    # The --server.port and --server.headless are good for Colab
    command = [
    ...
    streamlit_process = subprocess.Popen(
        ...
        #stdout=subprocess.PIPE,
        #stderr=subprocess.PIPE,
        start_new_session=True # Ensures the process continues after the script exits
    )
...
if __name__ == "__main__":
    ...
    # Use a simple loop to prevent the script from exiting
    try:
        while True:
